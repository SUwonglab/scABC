...
InSilicoForeGround = read.table(file = "NoTreatment/6Lines/InSilicoForeGround.txt", header = TRUE)
InSilicoBackGround = read.table(file = "NoTreatment/6Lines/InSilicoBackGround.txt", header = TRUE)
InSilicoPeaks = read.table(file = "NoTreatment/6Lines/InSilicoPeaks.txt", header = TRUE)
bamfile.table = read.table(file = "NoTreatment/6Lines/SRX&Type&Batch.txt")
```
...
```{r cache=TRUE}
InSilicoPeakSelection = getClusterSpecificPvalue(ForeGround=InSilicoForeGround, cluster_assignments = InSilicoLandMarkAssignments, background_medians = InSilicoBackGroundMedian, landmark = InSilicoLandMarks)
