...
head(InSilicoCell2LandmarkCorrelation, 10)
range(InSilicoCell2LandmarkCorrelation)
...
InSilicoGapStat = getGapStat(InSilicoForeGround, InSilicoBackGroundMedian, nClusters=1:20, nPerm = 20, quiet = TRUE)
